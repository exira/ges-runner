...
let referenceBinaries = [ "ges-runner\\ges-runner.exe" ]
// Web site location for the generated documentation
let website = "/ges-runner"

let githubLink = "http://github.com/exira/ges-runner"

// Specify more information about your project
let info =
  [ "project-name", "ges-runner"
    "project-author", "exira"
    "project-summary", "Exira.EventStore.Runner is a wrapper that uses Topshelf to run EventStore as a Windows Service"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/Exira.EventStore.Runner" ]
