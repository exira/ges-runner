...
let project = "Exira.EventStore.Runner"

// Short summary of the project
// (used as description in AssemblyInfo and as a short summary for NuGet package)
let summary = "Exira.EventStore.Runner is a wrapper that uses Topshelf to run EventStore as a Windows Service"

// Longer description of the project
// (used as a description for NuGet package; line breaks are automatically cleaned up)
let description = "Exira.EventStore.Runner is a wrapper that uses Topshelf to run EventStore as a Windows Service"

// List of author names (for NuGet package)
let authors = [ "exira" ]

// Tags for your project (for NuGet package)
let tags = "eventstore ges topshelf f#"

// File system information
let solutionFile  = "ges-runner.sln"
